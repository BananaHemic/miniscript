...
namespace Miniscript
{
    public struct SourceLine
    {
        ...
        public void Append(ref SourceLine other, int start, int len=-1)
        {
            ...
            Array.Copy(other.Chars, other.StartIdx + start, Chars, Length, len);
            Length = finalLen;
        }
        ...
        {
            int numChars = 1 + (int)Math.Log10(num);
